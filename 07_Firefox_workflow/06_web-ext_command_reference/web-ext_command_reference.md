...
Declares that your extension will be self-hosted. This disables messages
...
---|---  
`firefox` | The [release](https://www.mozilla.org/en-US/firefox/new/) build of
Firefox  
`beta` | The [beta](https://www.mozilla.org/en-US/firefox/channel/desktop/)
build of Firefox  
...
this will default to `https://addons.mozilla.org/api/v3` which is the
production API.
...
Number of milleseconds to wait before giving up on a response from Mozilla's
web service. This should always be a number.
...
including the command name as you request help, for example `web-ext --help
run`.
