...
on_Debugger)  which allows you set breakpoint. There is currently no way to
[start Add-on Debugger directly from web-ext](https://github.com/mozilla/web-
ext/issues/759).

If we want send messages back from the content script to the background page,
we would use `[runtime.sendMessage()](/en-US/docs/Mozilla/Add-
