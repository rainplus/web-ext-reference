...
running and so forth.
    ...
    void startup(\xa0 data,\xa0 reason); 
...
shut down, and objects disposed of.
    ...
    void shutdown(\xa0 data,\xa0 reason);
...
is installed, upgraded, or downgraded.
    ...
    void install(\xa0 data,\xa0 reason); 
...
`}`
    ...
    void uninstall(\xa0 data,\xa0 reason); 
...
`installPath`| `nsIFile`| The installation location of the add-on
...
`oldVersion`| `string`| The previously installed version, if the
