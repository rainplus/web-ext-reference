...
ons/WebExtensions/Anatomy_of_a_WebExtension#Background_scripts) and in any
other documents bundled with the extension, including [browser action](/en-
US/docs/Mozilla/Add-ons/WebExtensions/Browser_action) or [page action](/en-
US/docs/Mozilla/Add-ons/WebExtensions/Page_actions) popups, [sidebars](/en-
US/docs/Mozilla/Add-ons/WebExtensions/Sidebars), [options pages](/en-
US/docs/Mozilla/Add-ons/WebExtensions/Options_pages), or [new tab pages](/en-
US/Add-ons/WebExtensions/manifest.json/chrome_url_overrides). A few of these
APIs can also be accessed by an extension's [content
scripts](https://developer.mozilla.org/en-US/Add-
ons/WebExtensions/Anatomy_of_a_WebExtension#Content_scripts) (see the [list in
...
of promises for asynchronous functions. As a porting aid, the Firefox
implementation of WebExtensions APIs supports `chrome` and callbacks as well
as `browser` and promises. Mozilla has also written a polyfill which enables
...
[API reference documentation](/en-US/docs/Mozilla/Add-
ons/WebExtensions/API/browserAction)

## browserSettings

[API reference documentation](/en-US/docs/Mozilla/Add-
ons/WebExtensions/API/browserSettings)
...
[API reference documentation](/en-US/docs/Mozilla/Add-
ons/WebExtensions/API/browsingData)
...
[API reference documentation](/en-US/docs/Mozilla/Add-
ons/WebExtensions/API/clipboard)
...
[API reference documentation](/en-US/docs/Mozilla/Add-
ons/WebExtensions/API/commands)
...
[API reference documentation](/en-US/docs/Mozilla/Add-
ons/WebExtensions/API/devtools.network)
...
[API reference documentation](/en-US/docs/Mozilla/Add-
ons/WebExtensions/API/extension)
...
[API reference documentation](/en-US/docs/Mozilla/Add-
ons/WebExtensions/API/extensionTypes)
...
[API reference documentation](/en-US/docs/Mozilla/Add-
ons/WebExtensions/API/identity)
...
[API reference documentation](/en-US/docs/Mozilla/Add-
ons/WebExtensions/API/management)
...
[API reference documentation](/en-US/docs/Mozilla/Add-
ons/WebExtensions/API/pageAction)
...
[API reference documentation](/en-US/docs/Mozilla/Add-
ons/WebExtensions/API/sessions)
...
[API reference documentation](/en-US/docs/Mozilla/Add-
ons/WebExtensions/API/topSites)

## types

Defines the `BrowserSetting` type, which is used to represent a browser
setting.

[API reference documentation](/en-US/docs/Mozilla/Add-
ons/WebExtensions/API/types)
