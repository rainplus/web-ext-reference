...
`@@ui_locale`| The current locale; you might use this string to
construct locale-specific URLs.  
`@@bidi_dir`| The text direction for the current locale, either "ltr"
